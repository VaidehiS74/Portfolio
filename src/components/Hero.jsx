...
import profilePic from "../assetss/V1.jpg"
...
const Hero = () => {
  return (
    <div className='overflow-x-hidden border-b border-neutral-900 pb-4 lg:mb-35'>
        <div className='flex flex-wrap'>
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col items-center lg:items-start'>
                    <motion.h1 
                        ...
                        initial="hidden"
                        animate="visible"
                        className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Vaidehi Singh
                    </motion.h1>
            ...
            <div className='flex justify-center '>
                <motion.img 
                    ...
                    src={profilePic} className='rounded-xl h-[580px]' alt='Vaidehi-Singh'></motion.img>
            </div>
            </div>
        </div>
    </div>
